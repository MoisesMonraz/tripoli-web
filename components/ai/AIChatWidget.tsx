          ...
          <div className="pointer-events-none absolute right-full top-1/2 mr-2 sm:mr-3 -translate-x-[48px] sm:-translate-x-[62px] -translate-y-1/2">
            ...
            >
              <button
                ...
                className="pointer-events-auto absolute right-1.5 top-1/2 -translate-y-1/2 rounded-full p-0.5 md:p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 text-lg md:text-xl"
                aria-label={strings.ariaClose}
              >
                ×
              </button>

  ...
  return (
    ...
    >
      <div className="space-y-1">
        ...
        <h2 className="text-[22px] font-semibold font-raleway text-white">Sesion estrategica inicial</h2>
        <p className="text-sm font-semibold text-slate-100 text-justify">Conozca como los servicios y soluciones de Tripoli Media pueden impulsar su empresa</p>
      </div>

      <p className="text-sm leading-snug text-slate-300 text-justify">Agende su primera reunion virtual sin costo con uno de nuestros ejecutivos para evaluar sus necesidades, identificar oportunidades y definir posibles lineas de colaboracion.</p>

      <div className="space-y-1 text-sm text-slate-200">
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            <IconClock className="text-slate-400" />
            <span className="font-semibold">Cita con espacio de 1 hora</span>
          </div>
          <div className="flex items-center gap-2">

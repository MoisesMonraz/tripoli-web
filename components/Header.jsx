  ...
  const renderRightControls = () => (
    <>
      ...
      <Link
        ...
        className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full border border-slate-200 bg-white/80 shadow-sm transition hover:-translate-y-0.5 hover:border-[#00BFFF] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00BFFF] active:scale-[0.99] dark:border-slate-700 dark:bg-slate-900/80 dark:hover:border-[#33ceff] dark:focus-visible:outline-[#33ceff]"
      >
        <svg
          className="h-[20px] w-[20px] sm:h-[24px] sm:w-[24px] text-[#00BFFF] dark:text-white transition-colors"
          viewBox="0 0 24 24"
          fill="currentColor"
          aria-hidden="true"
        >
    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center w-full py-2">
          <div className="mx-auto flex w-full max-w-[70rem] items-center px-3 sm:px-4">
            ...
            <div className="flex items-center justify-end gap-1.5 sm:gap-2.5 md:gap-3 min-w-0">
              {renderRightControls()}
            </div>
          </div>
        </div>

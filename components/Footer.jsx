  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-6 py-8 md:grid-cols-[1fr_auto_1fr] md:gap-4">
          <div className="flex items-center justify-center md:justify-start gap-3 text-[16px] font-semibold tracking-[0.05em] text-slate-700 dark:text-slate-200 font-raleway">
            <FooterNavLink
              href="/conocenos"
          ...
          <div className="flex items-center justify-center">
            <Link href="/" aria-label={isEN ? "Go to homepage" : "Ir a la pagina principal"}>
              <Image src={logoSrc} alt="Tripoli Media" width={34} height={34} className="h-[34px] w-[34px] object-contain" />
            </Link>
          </div>

          <div className="flex items-center justify-center md:justify-end gap-2.5 text-[#04071A] dark:text-[#33ceff]">
            {socials.map((item) => {
              ...
              return (
                <a
                  ...
                  className="tm-social-icon flex h-[32px] w-[32px] items-center justify-center transition duration-200 hover:-translate-y-0.5 hover:scale-[1.03] hover:text-[#33ceff] dark:hover:text-[#66deff]"
                  ...
                  <span className="flex h-[32px] w-[32px] items-center justify-center">
                    {Icon ? (
                      ...
                      <Image
                        ...
                        width={32}
                        height={32}
                        className="tm-social-img h-[32px] w-[32px] object-contain"
        ...
        <div className="pb-6 flex flex-col items-center gap-2 text-xs text-slate-500 dark:text-slate-400 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2 justify-center md:justify-end">
            <Link
              ...
              className={`no-underline hover:no-underline transition text-slate-500 dark:text-slate-300 hover:text-slate-700 dark:hover:text-slate-100 ${
                isPrivacyActive ? "font-semibold" : "font-normal hover:font-semibold"
              }`}
            >
            ...
            <Link
              ...
              className={`no-underline hover:no-underline transition text-slate-500 dark:text-slate-300 hover:text-slate-700 dark:hover:text-slate-100 ${
                isTermsActive ? "font-semibold" : "font-normal hover:font-semibold"
              }`}
            >
...
function FooterNavLink({ href, label, isActive }) {
  return (
    <Link
      ...
      className={`group relative inline-flex pb-1 transition hover:opacity-75 ${
        isActive
    ...
    >
      <span>{label}</span>
      <span
        className={`absolute left-0 right-0 -bottom-0.5 h-[1.5px] origin-left bg-gradient-to-r from-[#00BFFF] to-[#33ceff] transition duration-200 ease-out ${

  ...
  return {
    ...
    author: (() => {
      ...
      if (authorEntry?.fields) {
        ...
        const cmsName = authorEntry.fields.name || 'Tripoli Publishing House';
        const cmsSlug = authorEntry.fields.slug || null;
        
        // Priority: Registry mapping > CMS slug
        // This ensures "Moisés Monraz" redirects to "moises-monraz-escoto"
        const finalSlug = getAuthorSlugByName(cmsName) || (cmsSlug === "moises-monraz" ? "moises-monraz-escoto" : cmsSlug);

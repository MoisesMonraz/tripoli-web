    ...
    <section className="flex flex-col gap-4 px-4 max-w-[70rem] mx-auto w-full sm:px-[12px] md:px-4">
        <div className="relative w-full">
          <div className="relative z-10 flex items-stretch gap-0">
            ...
            {titleHref ? (
              <Link href={titleHref}>
                <h2 className="block px-3 text-lg lg:text-xl font-semibold uppercase font-raleway max-w-[65%] sm:max-w-none line-clamp-2 sm:line-clamp-none sm:inline-flex sm:h-[44px] sm:items-center tracking-[0.05em] transition-colors text-[#312783] bg-white dark:bg-transparent hover:text-[#211452] dark:hover:text-[#c8c1e1]">
                  {title}
                </h2>
              </Link>
            ) : (

    ...
    <section className="flex flex-col gap-4 px-4 max-w-[70rem] mx-auto w-full sm:px-[12px] md:px-4">
      <div className="relative w-full">
        <div className="relative z-10 flex items-stretch gap-0">
          ...
          {titleHref ? (
            <Link href={titleHref}>
              <h2 className="inline-flex h-auto sm:h-[44px] items-center px-3 py-2 sm:py-0 text-lg lg:text-xl font-semibold uppercase font-raleway max-w-[65%] sm:max-w-none whitespace-normal tracking-[0.05em] transition-colors text-[#e6007e] bg-white dark:bg-transparent hover:text-[#8d004c] dark:hover:text-[#f9d3e6]">
                {title}
              </h2>
            </Link>
          ) : (

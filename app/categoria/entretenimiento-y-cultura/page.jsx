...
export default function EntretenimientoCulturaPage() {
  ...
  return (
    <main className="flex flex-col gap-4 pb-12">
      ...
      <SectionBlock title={labels.fabricantes} posts={placeholderPosts} titleHref="/categoria/entretenimiento-y-cultura/productoras-de-contenido" moreHref="/categoria/entretenimiento-y-cultura/productoras-de-contenido" />
      ...
      <SectionBlock title={labels.cadenas} posts={placeholderPosts} titleHref="/categoria/entretenimiento-y-cultura/recintos-culturales" moreHref="/categoria/entretenimiento-y-cultura/recintos-culturales" />
      ...
      <SectionBlock title={labels.conveniencia} posts={placeholderPosts} titleHref="/categoria/entretenimiento-y-cultura/festivales-eventos-artistas" moreHref="/categoria/entretenimiento-y-cultura/festivales-eventos-artistas" />

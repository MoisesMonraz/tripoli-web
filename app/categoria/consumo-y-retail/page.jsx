...
export const metadata = {
  ...
  description: "Noticias y artículos sobre consumo, retail, fabricantes, proveedores, cadenas comerciales y tiendas de conveniencia.",
};
...
export default async function ConsumoRetailPage() {
  const [fabricantesData, cadenasData, convenienciaData] = await Promise.all([
    ...
    getArticlesBySubcategory("consumo-y-retail", "tiendas-de-conveniencia", 6),
  ]);
